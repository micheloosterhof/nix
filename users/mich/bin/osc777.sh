#!/usr/bin/env bash
# ABOUTME: Raises a desktop notification on the local terminal's host via
# ABOUTME: OSC 777, wrapping in tmux/screen DCS passthrough when needed.
# Vendored from ambroisie/nix-config pkgs/osc777 (MIT).
