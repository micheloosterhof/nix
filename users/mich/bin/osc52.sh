#!/usr/bin/env bash
# ABOUTME: Copies stdin or an argument to the local terminal's clipboard via
# ABOUTME: OSC 52, wrapping in tmux/screen DCS passthrough when needed.
# Vendored from ambroisie/nix-config pkgs/osc52 (MIT).
